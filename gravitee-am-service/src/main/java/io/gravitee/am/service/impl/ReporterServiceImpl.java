...
public class ReporterServiceImpl implements ReporterService {
    ...
    @Override
    public Single<Reporter> create(String domain, NewReporter newReporter) {
    ...
    @Override
    public Single<Reporter> update(String domain, String id, UpdateReporter updateReporter) {
        ...
        return reporterRepository.findById(id)
                ...
                .flatMapSingle(reporter -> {
                    ...
                    return reporterRepository.update(reporter)
                            .flatMap(reporter1 -> {
    ...
    @Override
    public Completable delete(String reporterId) {
        ...
        return reporterRepository.findById(reporterId)
                ...
                .flatMapCompletable(reporter -> {
                    ...
                    return reporterRepository.delete(reporterId).andThen(domainService.reload(reporter.getDomain(), event)).toCompletable();
                })
                .onErrorResumeNext(ex -> {
                    if (ex instanceof AbstractManagementException) {
